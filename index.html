...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    section h2{
      font-family:var(--heading-font);font-size:1.75rem;color:var(--accent-dark);
      margin-bottom:1rem;border-bottom:2px solid var(--accent);
...
<body>
  ...
  <main>
    <section id="about-me">
      <h2>About Me</h2>
      <div class="card">
        <p>I am a data analyst with 7+ years of experience turning data into actionable insights for product, marketing, and executive teams.</p>
        <p>Recent achievements include building end‑to‑end reporting infrastructure in Tableau &amp; SQL, designing A/B experiments that increased conversion by 19 bps, and leading a small analytics team. I hold a B.S. in Mathematics &amp; Economics.</p>
        <p><strong>Core skills:</strong> SQL, Python (Pandas &amp; scikit‑learn), Tableau, Excel/Google Sheets, A/B Testing, Google Analytics, Leadership.</p>
        <p>Beyond querying databases, I explore emerging AI tools to streamline everyday workflows.</p>
        <p class="small">Find me on <a href="#" target="_blank" rel="noopener">LinkedIn</a>.</p>
      </div>
    </section>
    ...
    <section id="about-course">
      ...
      <div class="card">
        <p><em>Generative AI for Work &amp; Research</em> is a hands‑on program where we learn to harness AI to automate routine tasks, organize knowledge, and communicate insights with impact:</p>
        <ul>
        ...
        <p>I’m eager to embed these capabilities into my analytics toolkit—accelerating data prep, content creation, and insight generation for stakeholders.</p>
      </div>
    </section>
    ...
    <section id="submissions">
      ...
      <div class="grid">
        <article class="article-card">
          <img src="https://source.unsplash.com/collection/190727/640x360" alt="Submission thumbnail" />
          <div class="info">
            <h3>Week 1: Automating Data Tasks with Python</h3>
            <p>A walk‑through of my script that cleans, transforms, and summarizes CSV exports in seconds.</p>
